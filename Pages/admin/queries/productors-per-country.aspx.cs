...
{
    public partial class productors_per_country : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                string query = "SELECT * FROM ProductorsPerCountry";
                DataSet ds = GetDataSet(query);
                string table = "<table><tr><td>שם מדינה</td><td>סך יצרנים</td></tr>";
